...
class TxTests(helpers.TestCase):
    ...
    def test_bind_sends_exchange_declare(self, rpc):
        ...
        self.assertIsInstance(
            rpc.mock_calls[0][1][0], specification.Exchange.Declare
        )
    ...
    def test_bind_sends_exchange_delete(self, rpc):
        ...
        obj.delete()
        self.assertIsInstance(
            rpc.mock_calls[0][1][0], specification.Exchange.Delete
        )
    ...
    def test_bind_sends_exchange_bind(self, rpc):
        ...
        obj.bind('a', 'b')
        self.assertIsInstance(
            rpc.mock_calls[0][1][0], specification.Exchange.Bind
        )
    ...
    def test_bind_sends_exchange_unbind(self, rpc):
        ...
        obj.unbind('a', 'b')
        self.assertIsInstance(
            rpc.mock_calls[0][1][0], specification.Exchange.Unbind
        )
