...
class ServerCapabilitiesTest(helpers.TestCase):
    ...
    def test_publisher_confirms_enabled(self):
        self.channel._server_capabilities['publisher_confirms'] = True
