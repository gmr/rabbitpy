    ...
    **Automated features**
    ...
    def __init__(
        ...
        if self._invalid_properties:
            raise KeyError(f'Invalid property: {self._invalid_properties[0]}')
    ...
    # Map pamqp 4 amqp_type strings to Python types for coercion
    _AMQP_TYPE_MAP: typing.ClassVar[dict[str, str]] = {
        'shortstr': 'str',
        'octet': 'int',
        'table': 'dict',
        'timestamp': 'datetime',
    ...
    def _coerce_properties(self) -> None:
        ...
        for key, value in self.properties.items():
            if self.properties[key] is None:
                continue
            try:
                amqp_type = commands.Basic.Properties.amqp_type(key)
            ...
            elif python_type == 'dict' and not isinstance(value, dict):
    ...
    @property
    def _invalid_properties(self) -> list[str]:
