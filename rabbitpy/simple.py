...
def get(
    uri: str | None = None, queue_name: str | None = None
...
def delete_queue(uri: str | None = None, queue_name: str = '') -> None:
...
def delete_exchange(
    uri: str | None = None, exchange_name: str | None = None
) -> None:
