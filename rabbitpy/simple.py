...
def consume(uri: str | None = None,
    ...
    with SimpleChannel(uri) as chan:
        ...
        yield from queue.consume(no_ack, prefetch, priority)


def get(uri: str | None = None,
        queue_name: str | None = None) \
...
def publish(uri: str | None = None,
    ...
    with SimpleChannel(uri) as chan:
        msg = message.Message(chan, body or '', properties or {})
        if confirm:
...
def create_queue(uri: str | None = None,
                 queue_name: str = '',
                 durable: bool = True,
...
def delete_queue(uri: str | None = None,
                 queue_name: str = '') -> None:
...
def create_direct_exchange(uri: str | None = None,
                           exchange_name: str | None = None,
...
def create_fanout_exchange(uri: str | None = None,
                           exchange_name: str | None = None,
                           durable: bool = True) -> None:
...
def create_headers_exchange(uri: str | None = None,
                            exchange_name: str | None = None,
                            durable: bool = True) -> None:
...
def create_topic_exchange(uri: str | None = None,
                          exchange_name: str | None = None,
                          durable: bool = True) -> None:
...
def delete_exchange(uri: str | None = None,
...
def _create_exchange(uri: str | None,
